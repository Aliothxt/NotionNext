...
const BLOG = {
  AUTHOR: 'cyanCat', // 作者
  BIO: '不想写😅', // 作者简介
  LINK: 'https://cyan.cat', // 网站地址
  KEYWORDS: 'Notion, 博客, cyanCat', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '5a28f773457440108b3480d9a574d7a8', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'niepan1@foxmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'cyanCat BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
